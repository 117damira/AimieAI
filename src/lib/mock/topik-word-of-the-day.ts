  ...
  "1": [
    {
      ...
      icon: "📖",
      definition: {
        en: "Family — the group of people related to you, such as parents and siblings.",
        ru: "Семья — группа людей, связанных с вами родством, например родители и братья/сёстры.",
        kz: "Отбасы — ата-ана, аға-іні сияқты сізбен туыстас адамдар тобы.",
      },
      goodContexts: {
        en: ["Talking about who you live with", "Describing your parents, siblings, or relatives"],
        ru: ["Разговор о том, с кем вы живёте", "Описание родителей, братьев/сестёр или родственников"],
        kz: ["Кіммен бірге тұратыныңыз туралы айту", "Ата-анаңызды, аға-іні/қарындастарыңызды немесе туыстарыңызды сипаттау"],
      },
      badContexts: {
        en: ["Referring to a close friend who isn't related to you (use '친구' instead)", "Talking about coworkers at your job"],
        ru: ["Обозначение близкого друга, не являющегося родственником (используйте «친구»)", "Разговор о коллегах по работе"],
        kz: ["Туыс емес жақын досты білдіру («친구» қолданыңыз)", "Жұмыстағы әріптестер туралы айту"],
      },
      exampleSentences: ["저는 가족과 같이 살아요.", "우리 가족은 네 명이에요."],
    },
    {
      id: "topik_wotd_1_2",
      word: "음식",
      ...
      icon: "📖",
      definition: {
        en: "Food — anything eaten for nourishment.",
        ru: "Еда — всё, что едят для питания.",
        kz: "Тамақ — қоректену үшін ішетін кез келген нәрсе.",
      },
      goodContexts: {
        en: ["Talking about what you like to eat", "Describing a restaurant's menu or a country's cuisine"],
        ru: ["Разговор о том, что вы любите есть", "Описание меню ресторана или кухни страны"],
        kz: ["Не жегенді ұнататыныңыз туралы айту", "Мейрамхана мәзірін немесе елдің тағамдарын сипаттау"],
      },
      badContexts: {
        en: ["Talking about drinking liquids only (pair with '음료' for drinks)", "Describing a completely inedible object"],
        ru: ["Разговор только о напитках (для напитков используйте «음료»)", "Описание совершенно несъедобного предмета"],
        kz: ["Тек сусын туралы айту (сусын үшін «음료» қолданыңыз)", "Мүлдем жарамсыз затты сипаттау"],
      },
      exampleSentences: ["한국 음식을 좋아해요.", "이 식당은 음식이 맛있어요."],
    },
    {
      id: "topik_wotd_1_3",
      word: "이름",
