...
/**
 * DELF Listening — moved verbatim (byte-identical behavior) from what used
 * to be app/(app)/listening/page.tsx's default export, so that page can
 * become a thin exam-routing wrapper. Only the function name and export
 * style changed (default -> named), matching the DelfWritingPage/
 * DelfVocabularyPage/etc. sibling pattern; no other logic was touched.
 */
export function DelfListeningPage() {
