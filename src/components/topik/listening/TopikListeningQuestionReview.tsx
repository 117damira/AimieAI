...
/** Mirrors components/listening/ListeningQuestionReview.tsx exactly,
 * reusing t.listening.review verbatim — every label there ("Correct
 * answer", "Where in the recording", "Key words and expressions", etc.) is
 * already exam-agnostic. */
export function TopikListeningQuestionReview({
  question,
  questionNumber,
  selectedOptionIds,
  isCorrect,
