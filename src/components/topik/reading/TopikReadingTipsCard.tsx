...
/** Mirrors ReadingTipsCard exactly, reusing t.reading.tips verbatim since
 * that copy is already exam-agnostic (it never names DELF or TOPIK). */
export function TopikReadingTipsCard() {
  const { t } = useLanguage();
  return (
    <Card>
      <CardHeader>
